				...
				return (
					<Box
						sx={{
							...
							width: "100%",
							height: "100%",
							bgcolor: `rgba(0, 0, 0,${transparency ? transparency : "0.75"})`,
							color: "white",
							padding: "15px",
							pointerEvents: "none",
							display: "flex",
					...
					>
						{icon ? icon : <Typography variant="caption">{text}</Typography>}
					</Box>
				);
			case "border":
				return (
					<Box
						sx={{
							position: "absolute",
							bgcolor: `rgb(0, 0, 0, ${transparency ? transparency : "0.35"})`,
							bottom: 0,
							width: "100%",
							height: "100%",
							color: "white",
					...
					<Slide direction={anchor === "top" ? "down" : "up"} in={showOverlay}>
						<Box
							sx={{
								...
								width: "100%",
								bgcolor: `rgba(0, 0, 0, ${
									transparency ? transparency : "0.75"
								})`,
								color: "white",
								padding: "15px",
								pointerEvents: "none",
