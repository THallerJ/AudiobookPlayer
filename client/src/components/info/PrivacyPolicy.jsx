  ...
  const content = (
    <div>
      ...
      <Typography variant="body1" sx={{ pb: theme.spacing(1) }}>
        ...
        upon authentication. The google ID is used to map the access and refresh
      ...
      <Typography variant="body1" sx={{ pb: theme.spacing(1) }}>
        ...
        saved in the database on the server so that the user&apos;s audiobook
        library can be retrieved. The ID and title of the Google Drive files
        within the user&apos;s audiobook library are saved in the browser so the
        books can be displayed and streamed.
      </Typography>
      <Typography variant="body1" sx={{ pb: theme.spacing(1) }}>
        The user&apos;s progress in each audiobook is saved in the database so
        that progress can be synced across devices.
      </Typography>
      <Typography variant="body1">
      ...
      <Typography variant="body1" sx={{ pb: theme.spacing(1) }}>
        ...
        server to find a user&apos;s credentials on their behalf in a secure
        manner.
      </Typography>
      <Typography variant="body1">
